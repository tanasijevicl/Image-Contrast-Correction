...
## Buttons
set_property -dict { PACKAGE_PIN D19    IOSTANDARD LVCMOS33 } [get_ports { start_transfer }]; #IO_L4P_T0_35 Sch=BTN0
...
set_property -dict { PACKAGE_PIN Y11   IOSTANDARD LVCMOS33 } [get_ports { tx }]; #IO_L18N_T2_13      Sch=CK_A0
